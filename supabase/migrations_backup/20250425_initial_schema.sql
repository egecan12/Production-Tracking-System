...
CREATE TABLE production_logs (
    id UUID PRIMARY KEY,
    employee_id UUID REFERENCES employees(id) ON DELETE SET NULL ON UPDATE CASCADE,
    machine_id UUID REFERENCES machines(id) ON DELETE SET NULL ON UPDATE CASCADE,
